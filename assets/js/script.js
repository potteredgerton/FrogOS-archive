...
close(os_window)
/* Creating apps */
create_app("Google", "assets/images/web/google.webp", "google")
create_app("Games", "https://upload.wikimedia.org/wikipedia/commons/thumb/3/3b/Retroarch.svg/1024px-Retroarch.svg.png", "games")
create_app("Settings", "assets/images/apps/settings.png", "settings")
create_app("System Info", "assets/images/apps/system-information.png", "sysinfo")
//Functions
...
function window_open (id) {
    click.play()
    const google1 = "https://www.google.com"
    const games1 = "/games.html"
    const settings1 = "/settings.html"
    const sysinfo1 = "/info.html"
    let idsrc = id + "1"
    console.log(idsrc)
    brand_window.innerHTML = ""
    app_main.innerHTML = "<iframe src=" + idsrc + "></iframe>"
    init_window()
